...
function cekLogin() {
    ...
    if (!username) {
        Swal.fire({
            ...
            background: '#fef7e6', // Latar belakang kuning lembut untuk nuansa peringatan
            color: '#d63333', // Warna teks merah untuk menonjolkan peringatan
            iconColor: '#f39c12', // Warna ikon peringatan oranye
            customClass: {
            ...
            showClass: {
                popup: 'animate__animated animate__fadeInDown animate__faster' // Animasi masuk
            },
            hideClass: {
                popup: 'animate__animated animate__fadeOutUp animate__faster' // Animasi keluar
            }
        }).then(() => {
