...
function voidBarang(index) {
    // Verifikasi PIN dengan tampilan yang lebih modern
    Swal.fire({
        title: '<div class="void-title">Verifikasi PIN</div>',
        html: `
            <div class="void-container">
                <div class="void-icon-container">
                    <i class="fas fa-shield-alt"></i>
                </div>
                <p class="void-description">Masukkan PIN untuk melanjutkan proses void</p>
            </div>
        `,
        input: 'password',
        ...
        // Cek jika user mengklik konfirmasi dan memasukkan PIN yang benar
        if (pinResult.isConfirmed) {
            ...
            if (pin !== '451') {
                Swal.fire({
                    icon: 'error',
                    title: '<div class="void-title">PIN Salah</div>',
                    html: `
                        <div class="void-error-container">
                            <i class="fas fa-exclamation-circle void-error-icon"></i>
                            <p class="void-error-message">PIN yang Anda masukkan tidak valid.</p>
            ...
            // PIN benar, dapatkan detail item
            let keranjang = JSON.parse(localStorage.getItem('keranjang')) || [];
...
// Fungsi untuk memproses void dengan animasi dan tampilan yang lebih baik
function processVoid(index, alasan) {
    try {
        ...
        // Buat kode void dan timestamp saat ini
            ...
            html: `
                <div class="void-success-container">
                    ...
                    <div class="void-success-details">
                        ...
                        <div class="void-success-detail">
                            <span class="void-detail-key">Waktu:</span>
                            <span class="void-detail-value">${new Date().toLocaleTimeString()}</span>
                        </div>
                        <div class="void-success-detail">
